...
\begin{frame}{Fintech Innovation Research}
Three stages
\pause
\begin{itemize}[<+-| alert@+>]
\item Ideas and research
% identifying market caps, technological solutions and 
% regulatory gaps
\item Minimum Viable Product (MVP)
% development, user feedback and customer acquisition and competition
\item Maturity 
% attention shifts to operational efficiency, scaling and compliance
\end{itemize}
\end{frame}
...
\item Commission-less entertainment trading
\end{itemize}
\item Disintermediation
\begin{itemize}
\item internet banking
\item crowd funding
\item AI, decentralised finance and crypto
\end{itemize}
\end{itemize}
\end{frame}
...
\item Can cut borrowing costs with big data
...
\begin{frame}{Neural Network 2}
\includegraphics[scale = 0.6]{NNMA}
\end{frame}
...
\section{Access and Development}

\begin{frame}{Access}
	Fintech can provide access to finance
	\pause
\begin{itemize}[<+-| alert@+>]
	\item Transaction costs
		\begin{itemize}
		\item ease and technology
		\end{itemize}
	\item Information
		\begin{itemize}
			\item  reputation
...
\textbf{Journal of International Finanical Markets, Institutions and Money}\\
vol 103, Sep 2025
\end{block}
\end{frame}

\begin{frame}{Development 2}
45,770 firms across 20 countries from 2012-2020

Findings
  \pause
\begin{itemize}[<+-| alert@+>]
\item Bank lending and fintech are substitutes
\item Fintech lowers borrowing costs and boosts investment
\item Digital finance improves productivity 
\end{itemize}
\end{frame}
