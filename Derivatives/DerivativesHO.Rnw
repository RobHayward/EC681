...
c <- 2
v<- pmin(s - p + 2, 2)
plot(p, v, type = 'l', main = 'Payoff Short Call (strike 25)', xlab = 'Price of 
     underlying security', ylab = 'Payoff', col = 'DarkGreen')
...
c <- 2
v<- pmin(p - s + 2, 2)
plot(p, v, type = 'l', main = 'Payoff Short Put (strike 25)', xlab = 'Price of 
     underlying security', ylab = 'Payoff', col = 'DarkGreen')
text(32, -4, 'Pc = Min(S - P - C, -C)') 
@
\end{frame}
...
text(25, 8, 'Pc = Max(S - P - C, -C) and Pc = Max(S - P - C, -C)') 
@
\end{frame}
...
plot(p, v1 + v2, type = 'l', main = 'Payoff Short Straddle (strike 25)', xlab = 'Price of 
     underlying security', ylab = 'Payoff', col = 'DarkGreen')
abline(h = 0, col = 'black', lty = 2)
text(25, -8, 'Pc = Min(S - P - C, -C) and Pc = Min(S - P - C, -C)') 
@
\end{frame}
